...
> 1. Manually compare two models of boston housing data: the full model with all covariates and a model without crim and zn;
> 2. Sample 90% of the observation as the training set, then compare in-sample and out-of-sample performance between these reduced models.
