...
credit.glm <- glm(default~., 
                  data = credit_train, 
                  family=binomial)
#Get binary prediction
credit_test.pred.glm <- predict(credit.glm, credit_test, type="response")
#Calculate cost using test set
cost(credit_test$default, credit_test.pred.glm)
#Confusion matrix
table(credit_test$default, as.numeric(credit_test.pred.glm>1/6), dnn=c("Truth","Predicted"))
```
